...
module.exports = function (app) {
    ...
    app.post("/api/v1/user/signup", userValidationRules(), validate, controller.signup);
    app.post("/api/v1/user/login", loginValidationRules(), validate, controller.signin);
    ...
    app.patch("/api/v1/user/:id", verifyToken, userValidationRules(), validate, controller.updateUserDetails);
